...
# echo "CREATE DATABASE wordpress;" | mysql --port=3306 --host=http://127.0.0.28:5050 --user=root
# echo "USE wordpress;" | mysql --port=3306 --host=http://127.0.0.28:5050 --user=root
# echo "GRANT ALL PRIVILEGES ON wordpress.* TO 'root'@'http://127.0.0.28:5050' WITH GRANT OPTION;" | mysql --port=3306 --host=http://127.0.0.28:5050 --user=root
# echo "update mysql.user set plugin='mysql_native_password' where user='root';" | mysql --port=3306 --host=http://127.0.0.28:5050 --user=root
# echo "FLUSH PRIVILEGES;" | mysql --port=3306 --host=http://127.0.0.28:5050 --user=root
...
#echo "GRANT ALL PRIVILEGES ON wordpress.* TO 'root'@'%' WITH GRANT OPTION;" | mysql --port=3306 #--host=127.0.0.2 --user=root
#echo "UPDATE mysql.user SET plugin='mysql_native_password' where user='root';" | mysql --port=3306 #--host=127.0.0.2 --user=root
#echo "FLUSH PRIVILEGES;" | mysql --port=3306 --user=root
#sleep infinity & wait
